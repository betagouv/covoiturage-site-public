        ...
        <div className={fr.cx('fr-grid-row', 'fr-grid-row--gutters', 'fr-py-5v')}>
          <div className={`fr-col fr-col-md-3 ${style.col}`}>
            <div className={`fr-callout ${style.stat}`}>
              ...
              <p className={fr.cx('fr-callout__text')}>
                des déplacements en voiture sont réalisés à plusieurs  
              </p>
            </div>
          </div>
          <div className={`fr-col fr-col-md-3 ${style.col}`}>
            <div className={`fr-callout ${style.stat}`}>
              ...
              <p className={fr.cx('fr-callout__text')}>
                personnes par véhicule sur des distances inférieur à 100 km   
              </p>
            </div>
          </div>
          <div className={`fr-col fr-col-md-6 ${style.col}`}>
            <div className={`fr-callout ${style.analyse}`}>
              ...
              <p className={fr.cx('fr-callout__text')}>
                En 2019, 59 % des déplacements en voiture sont effectués à plusieurs. 
                Le covoiturage reste en revanche une pratique peu développée puisque seuls 3 % des passagers déclarent
                 avoir covoituré pour leurs déplacements en voiture. L’usage individuel du véhicule, désigné par le terme
                 d’« autosolisme » est majoritaire pour les déplacements en voiture de moins de 50 km.   
              </p>
            </div>
          </div>
        </div>     
